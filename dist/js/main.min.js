...
var About=function(e){var o={model:document.querySelectorAll('[data-model="About"]')};$com=e(o.model).find(".com"),$com.css("height",window.parent.screen.height)};
var Contact=function(o){var c={model:document.querySelectorAll('[data-model="Contact"]')};$com=o(c.model).find(".com"),$com.css("height","120px")};
var Home=function(e){var o={model:document.querySelectorAll('[data-model="Home"]')};$com=e(o.model).find(".com"),$com.css("height",window.parent.screen.height)};
var Improve=function(e){var o={model:document.querySelectorAll('[data-model="Improve"]')};$com=e(o.model).find(".com"),$com.css("height",window.parent.screen.height)};
var Research=function(e){var c={model:document.querySelectorAll('[data-model="Research"]')};$com=e(c.model).find(".com"),$com.css("height",window.parent.screen.height)};
var Work=function(e){var o={model:document.querySelectorAll('[data-model="Work"]')};$com=e(o.model).find(".com"),$com.css("height",window.parent.screen.height)};
