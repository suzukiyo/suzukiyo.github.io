...
var Menu=function(a){var i={btn:".gnavi_item > a"};a("#gnavi-menu").click(function(i){return a(".main_header").hasClass("popup")?(a(".main_header").removeClass("popup"),void a("body").css("position","static")):(a(".main_header").addClass("popup"),void a("body").css("position","fixed"))}),a(i.btn).on("click",function(){a("#gnavi-menu").click(),n(a(this).attr("href")+"-area")});var n=function(i){a("html,body").animate({scrollTop:a(i).offset().top})}};
var About=function(o){var e={model:document.querySelectorAll('[data-model="About"]')};$com=o(e.model).find(".com"),$com.css("height",o(window).height()+"px")};
var Contact=function(o){var c={model:document.querySelectorAll('[data-model="Contact"]')};$com=o(c.model).find(".com"),$com.css("height","150px")};
var Home=function(e){var o={model:document.querySelectorAll('[data-model="Home"]')};$com=e(o.model),$com.css("height",e(window).height()+"px")};
var Improve=function(o){var e={model:document.querySelectorAll('[data-model="Improve"]')};$com=o(e.model).find(".com"),$com.css("height",o(window).height()+"px")};
var Research=function(e){var o={model:document.querySelectorAll('[data-model="Research"]')};$com=e(o.model).find(".com"),$com.css("height",e(window).height()+"px")};
var Work=function(o){var e={model:document.querySelectorAll('[data-model="Work"]')};$com=o(e.model).find(".com"),$com.css("height",o(window).height()+"px")};
