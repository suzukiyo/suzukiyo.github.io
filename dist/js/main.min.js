...
var IndexController=function(e){e(document).click(function(){e("#menu").fadeOut("slow"),e("#overlay").fadeOut("slow")}),header=new Header(e),contents=new Contents(e),menu=new Menu(e),footer=new Footer(e)};
var Contents=function(e){home=new Home(e),about=new About(e),work=new Work(e),improve=new Improve(e),research=new Research(e),contact=new Contact(e)};
var Footer=function(o){o("#up").hide(),o(window).on("scroll",function(){o(this).scrollTop()>100?o("#up").fadeIn("slow"):o("#up").fadeOut("slow")}),o("#up").click(function(){return o("body,html").animate({scrollTop:0},500),!1})};
var Header=function(a){};
var Menu=function(n){var o={btn:".btn"};n("#menu-btn").click(function(o){"block"===n(".close-btn",this).css("display")?closemenu():(n("#overlay").length||($overlay=n("<div>").attr("id","overlay").css({background:"#666",width:n(document).width(),height:n(document).height(),opacity:".8",display:"none",top:0,left:0,position:"absolute","z-index":"1000"}),n("body").append($overlay)),n("#overlay").fadeIn("slow"),n("#menu").fadeTo("slow",.8,function(){n(".open-btn",this).fadeOut("slow"),n(".close-btn",this).fadeIn("slow")}).css({"z-index":"1001"})),o.stopPropagation()}),n(o.btn).on("click",function(){e(),t("#"+n(this).attr("id")+"-area")});var t=function(o){n("html,body").animate({scrollTop:n(o).offset().top})},e=function(){n("#menu").fadeOut("slow"),n("#overlay").fadeOut("slow"),n(".open-btn","#menu-btn").fadeIn("slow"),n(".close-btn","#menu-btn").fadeOut("slow")}};
var About=function(e){var o={model:document.querySelectorAll('[data-model="About"]')};$com=e(o.model).find(".com"),$com.css("height",window.parent.screen.height),e(window).resize(function(){$com.css("height",window.parent.screen.height)})};
var Contact=function(e){var o={model:document.querySelectorAll('[data-model="Contact"]')};$com=e(o.model).find(".com"),$com.css("height","120px"),e(window).resize(function(){$com.css("height",window.parent.screen.height)})};
var Home=function(e){var o={model:document.querySelectorAll('[data-model="Home"]')};$com=e(o.model).find(".com"),$com.css("height",window.parent.screen.height),e(window).resize(function(){$com.css("height",window.parent.screen.height)})};
var Improve=function(e){var o={model:document.querySelectorAll('[data-model="Improve"]')};$com=e(o.model).find(".com"),$com.css("height",window.parent.screen.height),e(window).resize(function(){$com.css("height",window.parent.screen.height)})};
var Research=function(e){var c={model:document.querySelectorAll('[data-model="Research"]')};$com=e(c.model).find(".com"),$com.css("height",window.parent.screen.height),e(window).resize(function(){$com.css("height",window.parent.screen.height)})};
var Work=function(e){var o={model:document.querySelectorAll('[data-model="Work"]')};$com=e(o.model).find(".com"),$com.css("height",window.parent.screen.height),e(window).resize(function(){$com.css("height",window.parent.screen.height)})};
new IndexController(jQuery);